...
export const PRESTIGE_UPGRADES: PrestigeUpgrade[] = [
  ...
  // County currency → Even more patronage
  {
    ...
    name: 'Feudal Ties',
    description: '+15% patronage income from higher tiers',
    cost: 2,
    tier: TierType.County,
    effect: { type: 'prestige_patronage_boost', value: 0.15 },
    purchased: false,
  },
  // Kingdom currency → Massive patronage
  {
    ...
    description: '+20% patronage income from higher tiers',
    cost: 1,
    tier: TierType.Kingdom,
    effect: { type: 'prestige_patronage_boost', value: 0.2 },
    purchased: false,
  },
  ...
  // Village currency → Small patronage boost
  {
    ...
    name: 'Village Tithe',
    description: '+5% patronage income from higher tiers',
    cost: 1,
    tier: TierType.Village,
  ...
  // Town: Guild Connections (+2% patronage per level)
  {
    ...
    description: '+1% patronage per level',
    cost: 2,
    tier: TierType.Town,
    effect: { type: 'prestige_patronage_boost', value: 0.01 },
    purchased: false,
